<template>
  <n-card title="项目信息" :bordered="false" size="small" class="rounded-8px shadow-sm">
    <n-descriptions label-placement="left" bordered size="small" :column="2">
      ...
      <n-descriptions-item label="Github 地址">
        <a class="text-primary" href="https://github.com/honghuangdc/soybean-admin" target="_blank">
          Github 地址
        </a>
      </n-descriptions-item>
...
const latestBuildTime = '2023-08-30 10:34:58'
</script>
