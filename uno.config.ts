...
export default defineConfig({
  ...
  theme: {
    colors: {
      ...
      primary_1: 'rgb(var(--primary-color-1))',
      primary_2: 'rgb(var(--primary-color-2))',
      primary_3: 'rgb(var(--primary-color-3))',
      primary_4: 'rgb(var(--primary-color-4))',
      primary_5: 'rgb(var(--primary-color-5))',
      primary_6: 'rgb(var(--primary-color-6))',
      primary_7: 'rgb(var(--primary-color-7))',
      primary_8: 'rgb(var(--primary-color-8))',
      primary_9: 'rgb(var(--primary-color-9))',
